...
*/
	...
	/*
	if ( Math.abs((Math.round(num1 * 100)/100) - (Math.round(num1 * 100)/100)) < 0.2) {
	    return true;
	}
	return false;
	...
	*/
    ...
    module.directive('subscribetoknobly', function() {
	return {
	    restrict: 'E',
	    scope: {
		parameter: '@',
    ...
    module.directive('subscribetoknoblycursor', function() {
	return {
	    restrict: 'E',
	    scope: {
		parameter: '@',
